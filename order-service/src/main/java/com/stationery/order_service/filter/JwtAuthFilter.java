package com.stationery.order_service.filter;

import com.stationery.order_service.service.AuthServiceClient;
...
public class JwtAuthFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest request) {
        ...
        // Payment confirmation is public
        if (path.equals("/api/orders/payment/confirm")) {
            return true;
        }
